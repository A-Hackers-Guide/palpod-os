...
def write_schematic():
    ...
    parts.append(f'\t\t(title "PAL Pod Orb")\n')
    parts.append(f'\t\t(date "2026-08-03")\n')
    parts.append(f'\t\t(rev "A0")\n')
    parts.append(f'\t\t(company "PAL Pod")\n')
...
def write_pcb():
    ...
    parts.append('    (title "PAL Pod Orb - PCB (Flex-Rigid 6-Layer)")\n')
    ...
    parts.append(add_text("PAL Pod Orb - Rev A0", -17, -12, "F.SilkS", 1.5, 0.2))
